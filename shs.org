...
* Week 7
#+attr_html: :style font-size:20px
Histoires et performativités des jeux vidéo

Quels ont été les ressorts de cette industrie récente et comment a-t-elle réussi
à s’infiltrer dans nos pratiques de tous les jours ?

** 1966-1983 : des premières recherches systèmatiques jusqu'à la "crise des jeux vidéo"
Le concept de programmes informatiques à visée ludiques est presque concomitant
à celui d’ordinateur. *Mais* – dans un premier temps – ces programmes avaient
comme but affiché la promotion et/ou l’exploration d’un nouveau système.
Donc dans les universités au départ, public restreint.

*** Ralph Baer
- Issu du domaine télévisuel.
- Travaille dans le département de recherche. Gagne du
statut en travaillant pour un équipementier militaire.
- 1966 Débloque fond pour un laboratoire TV, but construire boîtier se branchant
  à n'importe qu'elle tv.
- 1967
démo d'une "console" et d'un pistolet photoélectrique permettant de "jouer".
- 1968 /Brown Box/ premier prototype commercialisable, mais son entreprise
  refuse d'investir.
- 1970 Magnavox acquière les droits d'exploitation de la /Brown Box/
- 1972 lancement de la /Magnavox Odyssey/
- Lancement réussi, mais les ventes retombent rapidement :
  - Mauvaise stratégie marketing \rightarrow lie la console aux téléviseurs
    Magnavox, alors que compatible avec tous les téléviseurs
  - Concurrent : Atari et PONG
*** Atari et PONG
- S'inspire de l'Odyssey pour développer un jeu similaire associé à une borne à pièces
- 1972 : prototype testé et marche très bien
- 1973 : Magnavox attaque Atari en justice et gagne \rightarrow forcé d'acheter
  la licence + verser royalties
- Home Pong : 1975 150'000 unités vendues la première année
- 1975 : dans la précipitation, Atari ne parvient pas à breveter Home PONG
- 1978 : 75 versions de PONG coexistent sur des consoles différentes
*** Cartouche à mémoire
- 1976 : Fairchild Camera lance pour la première fois une console avec
  cartouches contenant les jeux
- Grâce notamment à l’abaissement des coûts des circuits intégrés, ce format
  deviendra la norme; un détachement s’opère progressivement entre les consoles
  et les jeux qu’elles supportent
*** Atari video computer system
- 1977: Atari lance la Video Computer System
- Un fois acquis les droits du jeu d’arcade très populaire Space Invaders, la
 console se vend à plus de 15 millions d’exemplaires entre 1979 et 1982
*** Durcissement du modèle
- Consoles de jeu comme dispositifs s’organisant autour d’un microprocesseur
  avec lesquels sont associés des cartouches disposant de mémoires sur
  lesquelles sont inscrites un ou plusieurs programmes ludiques
- Détachement entre consoles et jeux avec deux grandes conséquences:
  1. Changement dans l’établissement des prix d’achats; give away razors to sell blades
  2. Développeurs tiers peuvent se greffer sur les supports existants
*** 1983 : la crise des jeux vidéo
- Explosion de l’offre vidéo-ludique; jeux souvent bâclés
- Déploiement du personal computer permettant d’avantages de fonctionnalités

*Crise des jeux vidéo*:

Entre 1982 et 1983, seules 6 parmi les 130 entreprises de développement de jeux
vidéo récemment créées survivent à la baisse des ventes.

Il faudra attendre les années 1985-1990 pour que l’industrie vidéo-ludique s’en
remette, notamment via l’arrivée de nouveaux acteurs et de nouveaux modèles marchands
*** 3 éléments clés
1. Importance des recherches menées par le laboratoire de Sanders dans la
  définition des jeux vidéo comme produits de consommation à haute valeur ajoutée
2. Stratégie « razor/blade » instaurée par Atari en 1977 concomitante au
  détachement entre « consoles » et « jeux »
3. Multiplication des développeurs tiers à partir de 1977; explosion de l’offre
  vidéo-ludique et concurrence accrue des personnal computer
** 1985-2001 : Nouveaux acteurs et modèles marchands
*** Nintendo et la NES
Nintendo met en place quatre mesures afin d'assurer qualité + royalties de
production pour développeurs tiers :
1. Puce d'authentification pour chaque cartouche
2. label de qualité
3. Interdiction de proposer plus de 5 jeux par années
4. Définition des prix de tous ces jeux, même de ceux des tiers
*** Retour gagnant
- 1989 Sega \rightarrow détrône même Nintendo aux USA
- Durant les années 90 4 fois plus de revenus pour les jeux consoles que pour PC
*** "Two-sided plateform"
- Deux clientèle distincte pour les entreprises de consoles : les consommateurs
  et les développeurs
- Principe similaire à celui instauré par d'autres entreprises comme Microsoft
*** 1995 : Sony et la Playstation
- Prix de base inférieur à son concurrant Sega
- Utilisation de disque optique
- 1er système d'exploitation pour console
- Mise à disposition d'outils de développement pour les développeurs tiers

\Rightarrow Environnement propice aux développements de jeux vidéo plus
complexes et innovants

- Succès planétaire : en 2000 81mio de consoles vendues (N64: 29mio,Sega
  Dreamcast 17mio)
- Console la plus vendure jusqu'à aujourd'hui: 104 mio

**** Playstation 2 
- Permet l'utilisation des jeux Playstation 1 \rightarrow attractivité dès lancement
- Attractivité a motivé développeurs tiers à investir dans la création de jeux
  pour ce nouveau support *malgré* des outils de développement moins complets...
*** 2001: Microsoft et la Xbox
Innovations :
- Inclusion d'une carte réseau \rightarrow Xbox Live
- Inclusion d'un disque dur \rightarrow téléchargement de contenus
- Investissement massifs pour soutenir les développeurs tiers
*** Éléments clés
1. Instauration par Nintendo et Sega d’un marché biface qui s’adressent à la
  fois aux développeurs et aux consommateurs
2. Tendance forte mise en place par Sony puis renforcée par Microsoft
  d’investir dans les outils de développements afin de faciliter le travail des
  développeurs tiers
3. Depuis le lancement de Xbox Live, importance grandissante des plateformes de
  services en ligne et du téléchargement de contenus

** 2007-... : Smartphones et Freemium
- Smartphones \rightarrow nouveaux contextes de consommation et d'acquisition,
  nouveaux concepts marchands
*** Freemium
- Contraction de /free/ et /premium/
- Principe consistant à proposer des services payants qui influent plus ou moins
  sur le déroulement d'un cours d'action vidéoludique

\Rightarrow Ce principe marchand s’exprime à chaque fois différemment puisqu’il
se décline en fonction des cours d’action des jeux vidéo
*** Éléments clés
1. Influence grandissante de service en ligne
2. Boucle de rétroaction: le /freemium/ devient controversé et et suggère de
   nouvelles stratégies qui particpent à sa transformation
* Week 10
** Le réseau social
Ingénieurs passent beaucoup de temps à créer/entretenir des réseaux sociaux.
- Pourquoi ces réseaux sociaux ?
  - coordination techique
  - Organisation du travail
  - Supervision
  - Conseil
  - Formation
- Pourquoi construction dès la formation
  - Ressource dans le travail
  - Ressource/influence dans l'évolution de la carrière

Réseau social = capital social
- Ressources effective ou potentielles
- Dépend du nombre et leur propre capital

Réseau = influence
- Réseau plus influent et influencé qu'il est fortement connecté à d'autres
  - qui lui font confiance
  - obligation de la soutenir
  - ou qui dépendent d'échanges avec lui
  - peut être contraignant dans l'ouverture de la manière dont on pense
- Offre accès à des ressources encastrée dans une strucutre sociale
- Ressources politique qui permettent d'influencer les processsus décisionnels

Relation hors de l'entreprise
- donnent accès à des informations cruciales à
la réussite de projets
- Toutefois, risqué \rightarrow fuites d'informations
- Mode d'acquisition de connaissances
- Intégration des connaissances directement aux routines de l'organisation

Relation hautement personelles, parfois extra-professionnelles


** Ingénieur-e-s R&D en microélectronique
Enjeu = réussir la miniaturisaiton des circuits et d'augmenter leur performance
Trois formes de mobilisations :
*** Conseil technique
But :
Obtenir des connaissances pour résoudre rapidement des problèmes ou identifier
des idées nouvelles

Utilisation des réseau plutôt que les bases de connaissances
- Rapidité
- Difficulté à savoir précisément quoi chercher
- accès au savoir tacite
Dans la microélectronique, les *techniques* de fabrication sont très *complexes*
(grand nombre d’opérations interdépendantes) et les *connaissances* à intégrer
*dispersées*

Consultations ponctuelles, mais pas sur des connaissances confidentielles
\rightarrow Le respect de la confidentialité est même une *condition sine qua
non de la pérennisation de la relation*

 Réseau académique
- Accès à des connaissances spécialisées
- Réseau naturel facile à mobiliser
- Statut interne d'expert, fondé sur leurs relations externes

Réseau permet de savoir "qui sait quoi"

*** Recours à un service
Machines indispensables pour tester idées pas forcément disponible localement.

Négociation du passage prioritaire
*** Compréhension de l'environnement
La compréhension de l’environnement interne
- Concurrence entre équipes projet pour capter du soutien et des ressources
- Opposants potentiels et menaces sur le projet
- Connaissance des personnes et appuis éventuels sur lesquels compter
- Manière dont le projet est perçu en dehors de l’équipe projet
- Concurrence entre domaines d’expertise
- Interprétation des discours stratégiques de la direction
- « Faire passer un message »
- Donner de la visibilité au projet ou domaine d’expertise

La compréhension de l’environnement externe
- Partenariats avec d’autres entreprises, telles que des équipementiers
- Portes d’entrée dans l’organisation partenaire
  - pour que le projet y soit « poussé » et défendu
  - pour comprendre les attentes du partenaire
  - ou pour monter un projet
** Conclusion
RÉSEAU SOCIAL
- Complément important à l’expertise
- Évolue au cours du cycle de vie professionnel
  - S’accroît avec l’ancienneté
- Change de nature selon qu’il est tourné vers
  - l’université
  - les fournisseurs, concurrents, clients
  - l’intérieur de l’organisation
* Week 13
** Fait d'actualité
En quoi est-ce compliqué de bloquer l'accès des terroristes aux médias sociaux ?
- Techniquement ?
  - Main d'oeuvre qualifiée pour décider à partir de quel seuil on
    est un terroriste
  - E.g. Facebook, rapports des utilisateurs pour détecter, problème de détecter
    si abus car publié dans réseau proche
- Liberté d'expression
  - Entreprises liées à un mouvement libertariens, et défense de la liberté
    d'expression \rightarrow pour certains, pas le rôle des entreprises privées,
    mais plutôt de l'état
- Clés d'encryption, doivent-elles être partagées avec l'état ?
